...
* Переменная jmeter и jmeterServer влияют на выбор файлов для запуска теста.  
  ...
  файлы: jmeter-jmx, jmeter-server-jmx. Данный файлы нужны для мониторинга jmx-метрик Jmeter.
...
* Copying Files  
  Копирование и редактирование файлов на выбранных серверах. Этап выполняется параллельно.
* Start Jmeter Server  
